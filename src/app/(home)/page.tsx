        ...
        <div className="flex gap-5 items-scretch flex-col md:flex-row">
          <div className="flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="font-heading text-gray-200 font-bold text-xl">
                Sobre o evento
              </h2>
            ...
            <p className="text-gray-300 leading-relaxed text-sm md:text-base">
              ...
              mergulhar nas tendeências mais recentes em desenvolvimento de
              software, arquitetura de sistemas e tecnologia emergente, com
